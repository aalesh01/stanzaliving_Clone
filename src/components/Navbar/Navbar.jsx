    ...
    return (
      <div className="navbar_container">
        ...
        <div className="navbar_details">
          ...
          <Link to="/products">Explore Residences</Link>
        </div>
        <div>
          <Button
            ref={btnRef}
              ...
              <DrawerContent>
                ...
                <DrawerBody>
                  ...
                  <div className="navbar_profession">
                    ...
                    <RadioGroup
                      defaultValue="2"
                      className=".navbar_profession_RadioGroup"
                    >
                      <Stack
                        spacing={5}
                        direction="row"
                  ...
                  <div className="navbar_city">
                    ...
                    >
                      ...
                      <option value="Electronic City Phase1">
                        Electronic City Phase1
                      </option>
                      <option value="Electronic City Phase 2">
                      ...
                      <option value="Kundalahalli Gate">
                        Kundalahalli Gate
                      </option>
                  ...
                  <div className="navbar_duratation">
                    <Select
                      ...
                      focusBorderColor="gray"
                    >
                      <option value="Less then 3 months">
                        Less then 3 months
                      </option>
